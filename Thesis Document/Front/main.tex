...
\newcommand\FrontCoverPDF{
    \put(0,0){\parbox[b][297mm]{\coverwidth}{
		\parbox[b][297mm]{210mm}{% FRONT STARTS HERE
			\hspace{25mm}
			\begin{minipage}[b][297mm][t]{125mm}
				\vfill
				\parbox[b][180mm][c]{125mm}{
					...
					\setstretch{1.2} {\large~\\}
					{\LargeA \authrnolink \\}
					{\large Master's degree in \degree \\}
					{\small \deptnamenolink \\}
					{\small Faculty of Sciences of the University of Porto \\}
					{\small \the\year \\}
				}
				\vspace{5mm}
			\end{minipage}
			\hfill
			\begin{minipage}[b][297mm][b]{\sidew}
				\hspace*{-5mm}\includegraphics[width=60mm]{fcup}
				\includegraphics[scale=0.97]{title}
			\end{minipage}
		}
	}} % FRONT STOPS HERE
...
\AddToShipoutPicture*{\FrontCoverPDF}

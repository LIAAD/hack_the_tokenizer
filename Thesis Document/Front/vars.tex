...
% Department name
\department[http://dcc.fc.up.pt/]{Departamento de Ciências de Computadores}

% Supervisor info
% Supervisor name
\supervisor[mailto:example@fc.up.pt]{Prof. Alípio Jorge}
...
\supervisoraffiliation[]{Faculty of Sciences}

...
\usepackage{algpseudocode}  % for \State, \For, etc.


\usepackage[many]{tcolorbox} % in your preamble
\usepackage{soul} % for highlighting with justification


\usepackage{seqsplit} % safe breaking of long "words"
